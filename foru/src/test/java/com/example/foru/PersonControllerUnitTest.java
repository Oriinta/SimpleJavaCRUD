...
import com.example.foru.controllers.UserController;
...
public class PersonControllerUnitTest {
    ...
    public void whenCalledshowSignUpForm_thenCorrect() {
        ...
        assertThat(userController.showSignUpForm(person)).isEqualTo("add-user");
    }
    ...
    public void whenCalledaddUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.addUser(person, mockedBindingResult, mockedModel)).isEqualTo("redirect:/index");
    }
    ...
    public void whenCalledaddUserAndInValidUser_thenCorrect() {
        ...
        assertThat(userController.addUser(person, mockedBindingResult, mockedModel)).isEqualTo("add-user");
    }
    ...
    public void whenCalledupdateUserAndValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(1l, person, mockedBindingResult, mockedModel)).isEqualTo("redirect:/index");
    }
    ...
    public void whenCalledupdateUserAndInValidUser_thenCorrect() {
        ...
        assertThat(userController.updateUser(1l, person, mockedBindingResult, mockedModel)).isEqualTo("update-user");
    }
